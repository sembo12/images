...
Puma 
  ...
  - During development I prefer Webrick (single threaded and amazing at debugging) or Puma. 
  Rule of Thumb: *Development != Production* 
...
As you can see below, I've created a staging collection (I'll toss and create a new one with different data and URL) which will be supplied via the environment variable in heroku. Subsequent to that, I'll create another production instance with different user credentials.  
...
code: mongo ds017246.mlab.com:17246/appwebtech -u <dbuser> -p <dbpassword>
